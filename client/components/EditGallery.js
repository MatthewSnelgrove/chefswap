...
function GalleryImg(props) {
  return (
    <div
      className={`${styles.gallery_img_dim} ${styles.gallery_img_container}`}
    >
      <img src={props.imgJSON.imageLink} className={styles.gallery_img} />
      <button
        ...
        onClick={(e) => {
          props.setDeleteImg({
            accountUid: props.imgJSON.accountUid,
            imageUid: props.imgJSON.imageUid,
          });
        }}
      >
        <span
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button
              ...
              data-bs-dismiss="modal"
              onClick={(e) => deleteImg(props.setImages, props.deleteImg)}
            >
              Confirm
            </button>
          </div>
