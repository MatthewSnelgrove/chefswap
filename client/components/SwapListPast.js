...
function SwapListPast(props) {
  ...
  useEffect(() => {
    ...
    getMultipleRatings(
      getUserDateList(props.swapListPast),
      props.user,
      setRatingList
    );
  }, [props.swapListPast]);
          ...
          <Accordion disableGutters={true}>
            <SwapListing
              ...
              finalColJsx={
                <>
                  ...
                  ></AccordionSummary>
                  <button
                    title="Change users rating"
                    data-bs-toggle="modal"
                    data-bs-target="#RatingModal"
                    className="base-btn-lightblue"
                    onClick={(e) => {
                      setCurUser(swapData[1][0]);
                    }}
                  >
                    {ratingList[swapData[0]]
                      ? "Change rating"
                      : "Rate this user"}
                  </button>
                </>
            ...
            <AccordionDetails>
              <ThemeProvider theme={fontTheme}>
                <Typography>Previous Swaps:</Typography>
                {swapData[1].map((specificSwap) => (
                  <FormatTypography
                    time={specificSwap.requestTimestamp}
                  ></FormatTypography>
                ))}
              </ThemeProvider>
            </AccordionDetails>
...
function FormatTypography(props) {
  ...
  return (
    <Typography>
      <div className={styles.typography_text_container}>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalToggleLabel">
              {props.ratingList[props.curUser.username]
                ? "Change rating"
                : "Add new review"}
            </h5>
            <button
          ...
          <div class="modal-footer">
            <button
              ...
              onClick={(e) => {
                changeAvgRating(
                  props.user.accountUid,
                  props.curUser.accountUid,
                  rating,
                  ...
                  props.setRatingList((prevRatingList) => {
                    ...
                    if (curRating) {
                      ...
                      prevRatingList[props.curUser.username] = {
                        rating: rating,
                      };
                    }
