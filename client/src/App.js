...
import TEST_SESSION_PAGE from "./pages/TEST_SESSION_PAGE";
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/accounts/edit"
            element={
              <UserEditPage renderType={<EditProfile />} name="EditProfile" />
            }
          />
          <Route
            path="/accounts/password/change"
            element={
              <UserEditPage renderType={<EditPassword />} name="EditPassword" />
            }
          />
          <Route
            path="/accounts/gallery"
            element={
              <UserEditPage renderType={<EditGallery />} name="EditGallery" />
            }
          />
          <Route
            path="/accounts/personal"
            element={
              <UserEditPage renderType={<EditPersonal />} name="EditPersonal" />
            }
          />
          <Route path="/login" element={<Login />} />
          <Route path="/signup" element={<Signup />} />
          <Route
            path="/find-swap/search/:usernameQuery"
            element={<FindUserPage />}
          />
          <Route path="/test-session" element={<TEST_SESSION_PAGE />} />
        </Routes>
      </BrowserRouter>
    </QueryClientProvider>
  );
