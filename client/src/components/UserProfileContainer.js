    ...
    return (
        <div>
            <div className="user-container">
                ...
                <button className="user-button" onClick={linkPage} ><img src={isUser ? "edit.svg": "chat.svg"}></img></button>
                <div className="user-data shift-upwards">
                    <div class="add-tags">Cuisine Preferences: {user.cuisinePreferences.map((cuisine, index) =>
                        <Tag key={index} cuisine={cuisine} />
                    )}
                    </div>
                    <div className="add-tags">Cuisine Specialties: {user.cuisineSpecialities.map((cuisine, index) =>
                        <Tag key={index} cuisine={cuisine} />
                    )}</div>
