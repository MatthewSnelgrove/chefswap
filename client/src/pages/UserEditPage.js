      ...
      <ul className="list-links">
        <li style={type == "edit_profile" ? StyleSelected : {}}>
          <a
            className="full-a"
            onClick={(e) =>
              linkTo("edit_profile", "http://localhost:3000/accounts/edit")
            }
          />
        ...
        <li style={type == "change_password" ? StyleSelected : {}}>
          <a
            ...
            onClick={(e) =>
              linkTo(
                "change_password",
                "http://localhost:3000/accounts/password/change"
              )
            }
          />
        ...
        <li
          className="bottom-li"
          style={type == "edit_gallery" ? StyleSelected : {}}
        >
          <a
            className="full-a"
            onClick={(e) =>
              linkTo("edit_gallery", "http://localhost:3000/accounts/gallery")
            }
          />
        ...
        <li
          className="bottom-li"
          style={type == "edit_personal" ? StyleSelected : {}}
        >
          <a
            className="full-a"
            onClick={(e) =>
              linkTo("edit_personal", "http://localhost:3000/accounts/personal")
            }
          />
